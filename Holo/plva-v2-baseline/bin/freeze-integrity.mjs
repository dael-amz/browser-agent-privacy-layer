...
const targets = [
  ["dist", "dist-integrity.json"],
  ["baseline-app-dist", "baseline-app-dist-integrity.json"],
];
...
await writeFile(
  ...
  `${JSON.stringify({ schemaVersion: 1, files: sourceFiles }, null, 2)}\n`,
);

const sumRoots = ["runtime", "dist", "baseline-app-dist"];
const sums = [];
...
for (const file of [
  "baseline-app-dist-integrity.json",
  "dist-integrity.json",
