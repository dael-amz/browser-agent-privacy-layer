"""Local LLM mediator: approval verdicts and misbehavior trace review.
...
outage must never fail open: a mediator that is unreachable or times out
means deny.
...
class MediatorVerdict:
    ...
    def grant_kwargs(self, request: ApprovalRequest) -> dict[str, Any]:
        """Keyword arguments for ``SessionVault.grant_approval`` (the approval plug point)."""
